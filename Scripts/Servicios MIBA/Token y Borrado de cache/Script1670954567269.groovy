...
Response = WS.sendRequest(findTestObject('Object Repository/Servicios/Token MIBA'))

String body = Response.getResponseText()

Map ParsedToken = jsonSlurper.parseText(body)

GlobalVariable.Token_MIBA = ParsedToken.access_token
